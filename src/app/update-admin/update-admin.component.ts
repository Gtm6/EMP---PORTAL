...
export class UpdateAdminComponent implements OnInit {
  ...
  profilePictue: string = "https://www.freeiconspng.com/uploads/computer-user-icon-16.png"
  ...
  ngOnInit(): void {
    this.adminAPI.getAdminDetails().subscribe((res: any) => {
      ...
      if (res.profilePictue) {
        this.profilePictue = res.profilePic
      }
    })
  }
  ...
  getFile(event: any) {
    ...
    fr.onload = (event: any) => {
      ...
      this.profilePictue = event.target.result
